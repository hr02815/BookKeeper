...
namespace project
{
    public partial class Main : Form
    {
        ...
        private const string qryGetAllCustomers3 = "select distinct cu.idcustomers, cu.name from customers cu, purchase p where cu.idcustomers = p.customers_idcustomers and amount > paid";
        ...
        private const string qryGetAllCustomers6 = "select distinct cu.idcustomers, cu.name from customers cu, sale s where cu.idcustomers = s.customers_idcustomers and amount > paid";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (textBox4.Text.Length != 0 && textBox3.Text.Length != 0 && radioButton6.Checked == true)
            {
